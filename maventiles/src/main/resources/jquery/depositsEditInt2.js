...
$(document).ready(function(){
	$('#Save').click(function(){
		...
		$.ajax({
				type: 'GET',
				url: 'EditdepositInternalSave2.htm?txt='+value+"&id="+b,
    	...
    	{var b=document.getElementById('accountdepositid').value;
    		...
    		$.ajax({
					type: 'GET',
					url: "./EditdepositInternalUpdate2.htm?txt="+value+"&id="+row.internalnotesid+"&cdate="+row.inotescreateddate+"&cby="+row.inotescreatedby+"&id2="+b,
					dataType: 'html',
	...
	$('#Delete1').click(function(){
		...
		$.ajax({
				type: 'GET',
				url: 'EditdepositInternalDelete2.htm?txt='+row2.internalnotesid,
				success: function(textStatus) {
