...
<script type="text/javascript">
 ...
 var langs='${command.languages}';
 var langarray=langs.split(",");
 var value1=document.getElementById("Telugu").value;			  
 var value2=document.getElementById("Hindi").value;	
 var value3=document.getElementById("English").value;	
...
<body onload="MultipleLan();">
<div class="Anu11">
<br><br><br>
<form:form  action="regss" commandName="command" >
...
<tr><td>First name:</td><td><form:input path="firstname"/><form:errors path="firstname" cssClass="error" ></form:errors></td></tr>

<tr><td>Middle name:</td><td><form:input path="middlename"/><form:errors path="middlename"></form:errors></td></tr>

<tr><td>Last name:</td><td><form:input path="lastname"/><form:errors path="lastname"></form:errors></td></tr>

<tr><td>User name:</td><td><form:input path="username"/><form:errors path="username"></form:errors></td></tr>

<tr><td>Password:</td><td><form:password path="password"/><form:errors path="password"></form:errors></td></tr>

<tr><td>Confirm Password:</td><td><form:password path="confirmpassword"/><form:errors path="confirmpassword"></form:errors></td></tr>

<tr><td>Gender:</td><td><form:radiobutton path="gender" value="Male"/>Male

<form:radiobutton path="gender" value="Female"/>Female <form:errors path="gender"></form:errors></td></tr>

<tr><td>Date of Birth:</td><td><form:input path="DOB" id="datepicker-10"  readonly="true"/><form:errors path="DOB"></form:errors></td>
</tr>


<tr><td>EmailId:</td><td><form:input path="email"/><form:errors path="email"></form:errors></td></tr>

<tr><td>Phone number:</td><td><form:input path="phnum"/><form:errors path="phnum"></form:errors></td></tr>
<%-- 
<tr><td>Country:</td><td><form:select path="country" id="country" cssStyle="textbx;width:172px"  onchange="getStates(this.value);" cssClass="textbx">
...
<tr><td>State:</td><td><form:select path="state" id="state" cssStyle="textbx;width:172px" cssClass="textbx">
<option value="">Select</option>
 <option value="AP">AP</option>
  <option value="telenganna">Telenganna</option>
   <option value="tamilnadu">Tamilnadu</option>
   
</form:select></td></tr>
 --%>
 
<%--  <tr><td>Country:</td><td><form:select path="country" id="country" style="width:168px"> 
</form:select><form:errors path="country"></form:errors></td></tr>
<tr><td>State:</td><td><form:select path="state" id="state" style="width:168px">
...
</form:select><form:errors path="country"/></td>
</tr>

<tr><td>State:</td><td><form:select path="state" id="state" cssStyle="textbx;width:172px" cssClass="textbx">
<option value="">Select</option>
</form:select><form:errors path="state"/></td></tr>
<%-- <tr><td>City:</td><td><form:input path="city"/></td></tr> --%>

<tr><td>Address:</td><td><form:textarea path="address" rows="5" style="width:162px"/><form:errors path="address"></form:errors></td></tr>
<tr><td>Zipcode:</td><td><form:input path="zipcode"/><form:errors path="zipcode"></form:errors></td></tr>


<tr><td>Languages:</td><td><form:checkbox path="languages" id="Telugu" value="Telugu"/>Telugu

<form:checkbox path="languages" id="Hindi" value="Hindi"/>Hindi

<form:checkbox path="languages" id="English" value="English"/>English
<form:errors path="languages" cssClass="error" /></td></tr>


<tr><td></td><td><input type="submit" name="save" value="Submit"/><input type="button" value="Cancel" onclick='window.location.href="index.jsp"'/>
