...
$(document).ready(function(){
	$('#Save').click(function(){
		...
		$.ajax({
				type: 'GET',
				url: 'depositInternalNotes2.htm?txt='+value,
		...
		var row=$('#dg_internal').datagrid('getSelected');
    		...
    		$.ajax({
					type: 'GET',
					url: "./updateDepositInternalnotes2.htm?txt="+value+"&id="+row.internalnotesid+"&cdate="+row.inotescreateddate+"&cby="+row.inotescreatedby,
					dataType: 'html',
	...
	$('#Delete1').click(function(){
		...
		$.ajax({
				type: 'GET',
				url: 'delDepositInternalNotes2.htm?txt='+row2.internalnotesid,
				success: function(textStatus) {
